...
export interface Conduct {
  id: string; // Identificador único para cada conducta
  text: string;
}

export interface Tip {
  conductId: string; // A qué conducta está asociado este tip
  text: string;
}

// Usamos un Record para tipar el objeto de datos
const resourcesData: Record<string, { conducts: Conduct[], tips: Tip[] }> = {
  ...
  // Añadiríamos 'Desorganizado' aquí con su propio contenido.
};
